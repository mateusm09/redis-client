    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        function update(key, payload) {
            return new Promise(function (resolve, reject) {
                if (!client)
                    reject(new Error('client undefined'));
                client.set(key, payload, 'KEEPTTL', function (err) {
                    if (err)
                        reject(err);
                    resolve(true);
                });
        ...
        function updateObject(key, payload) {
            var _this = this;
            return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var obj, serializedJson;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!client)
                                reject(new Error('client undefined'));
                            return [4 /*yield*/, getObject(key)];
                        case 1:
                            obj = _a.sent();
                            if (!obj)
                                reject(new Error('no object to update'));
                            serializedJson = JSON.stringify(__assign(__assign({}, obj), payload));
                            client.set(key, serializedJson, 'KEEPTTL', function (err) {
                                if (err)
                                    reject(err);
                                resolve(true);
                            });
